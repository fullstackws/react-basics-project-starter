  ...
  return (
    <Box bg="lightblue" minHeight="100vh" p={0}>
      ...
      <Box
        ...
        borderRadius="lg"
        boxShadow="md"
        width={["90%", "80%", "70%", "60%"]} // Responsive width
        maxWidth="630px"
        margin="0 auto"
        display="flex"
      ...
      >
        <Flex
          mb={4}
          width="100%"
          flexDirection={["column", "row"]} // Stack vertically below 600px
          alignItems="center"
        >
          <Input
            type="text"
            ...
            mr={[0, 2]} // No margin on small screens
            mb={[2, 0]} // Margin below on small screens
            flexGrow={1}
            maxWidth="300px"
          />
          <Select
            ...
            flexGrow={1}
            maxWidth="200px"
            mt={[2, 0]} // Add margin-top for small screens
          >
      ...
      <Flex flexWrap="wrap" justifyContent="center" m={0}>
        {filteredRecipes.length === 0 ? (
          <Text color="red.500" fontSize="lg" textAlign="center" width="100%">
